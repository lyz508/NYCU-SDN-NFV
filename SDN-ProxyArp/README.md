...
description: Proxy ARP application
---
# Proxy ARP
## Reference
- [org.onosproject.net.host](http://api.onosproject.org/1.8.9/org/onosproject/net/host/HostService.html)
    - HostService
    - host
    - EdgePortService
- org.onlab.packet
    - [ARP packet](http://api.onosproject.org/1.2.0/org/onlab/packet/ARP.html)

## ARP
- Request
    ![](https://i.imgur.com/10gJBUO.png)
- Reply
    ![](https://i.imgur.com/MEQvvRR.png)
    

## Workflow 
- First ARP packet received
    - use EdgePortService to get hosts on all Switches
    - emit ARP packet to get MAC address (except the input connect point)
...
- Other ARP packets
    ...
    - On record table
        ...
        - If found -> modified and emit ARP reply packet to device
