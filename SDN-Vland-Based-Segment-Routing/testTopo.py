...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h3 = self.addHost('h3', ip='10.0.3.2/16', mac='ea:e9:78:fb:fd:03')
        h4 = self.addHost('h4', ip='10.0.3.3/16', mac='ea:e9:78:fb:fd:04')
        h5 = self.addHost('h5', ip='10.0.2.13/16', mac='ea:e9:78:fb:fd:05')
